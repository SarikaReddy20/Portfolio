  ...
  const educationData = [
    {
      ...
      description:
        "Pursuing B.E. CSE with a current CGPA of 9.60/10 and a focus on software engineering, algorithms, and system design.",
    ...
    },
    {
      ...
      description:
        "Completed intermediate education in Mathematics, Physics, and Chemistry with a CGPA of 9.79/10.",
        ...
        <div className="grid md:grid-cols-2 gap-8 items-stretch">
          {educationData.map((edu, index) => (
            <ScrollReveal key={index} delay={index * 200} className="h-full">
              <div className="group relative h-full flex flex-col bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 p-8 overflow-hidden">
